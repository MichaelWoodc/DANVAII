...
fillpdfs.place_image('totalerrorsgraph.jpg', 125, 772, 'blankDocumentNumberLine.pdf', 'maingraphtest.pdf', 1, width=635, height=160)


# page2GraphStart = 5
# page2GraphWidth = 283
# page2GraphHeight = 15
# page2GraphVerticalOffset = -100
#The following are for the other graphs
fillpdfs.place_image('graphPictures/happyMisattributions.jpg', page2GraphStart, 583 + page2GraphVerticalOffset, 'pdfMagic/completed.pdf', 'pdfMagic/completed1.pdf', 2, width=widthmisattributions, height=heightmisattributions)
fillpdfs.place_image('graphPictures/sadMisattributions.jpg', page2GraphStart, 615 + page2GraphVerticalOffset, 'pdfMagic/completed1.pdf', 'pdfMagic/completed2.pdf', 2, width=widthmisattributions, height=heightmisattributions)
fillpdfs.place_image('graphPictures/angryMisattributions.jpg', page2GraphStart, 646 + page2GraphVerticalOffset, 'pdfMagic/completed2.pdf', 'pdfMagic/completed3.pdf', 2, width=widthmisattributions, height=heightmisattributions)
fillpdfs.place_image('graphPictures/fearfulMisattributions.jpg', page2GraphStart, 678 + page2GraphVerticalOffset, 'pdfMagic/completed3.pdf', 'pdfMagic/completed4.pdf', 2, width=widthmisattributions, height=heightmisattributions) 
fillpdfs.place_image('graphPictures/errorsbygender.jpg',page2GraphStart, 762 + page2GraphVerticalOffset, 'pdfMagic/completed4.pdf', 'pdfMagic/completed.pdf', 2, width=widthmisattributions, height=heightmisattributions)
